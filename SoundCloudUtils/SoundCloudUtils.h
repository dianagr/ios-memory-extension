...
//! Project version number for SoundCloudUtils.
FOUNDATION_EXPORT double SoundCloudUtilsVersionNumber;

//! Project version string for SoundCloudUtils.
FOUNDATION_EXPORT const unsigned char SoundCloudUtilsVersionString[];
